...
module.exports.renderEditForm = async (req, res) => {
  ...
  let liteImageUrl = foundListing.image.url;
  liteImageUrl = liteImageUrl.replace("upload", "upload/w_300");
  res.render("listings/edit.ejs", { listing: foundListing, liteImageUrl });
};
